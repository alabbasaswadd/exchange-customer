...
class _CurrenciesApiService implements CurrenciesApiService {
  _CurrenciesApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<CurrencyResponseModel> deleteCurrency(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
