...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StartupState<T>);
}
...
/// @nodoc
class $StartupStateCopyWith<T,$Res>  {
$StartupStateCopyWith(StartupState<T> _, $Res Function(StartupState<T>) __);
}


/// Adds pattern-matching-related methods to [StartupState].
extension StartupStatePatterns<T> on StartupState<T> {
...
class _Initial<T> implements StartupState<T> {
  const _Initial();
...
class Loading<T> implements StartupState<T> {
  const Loading();
...
class Success<T> implements StartupState<T> {
...
@override
String toString() {
  return 'StartupState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $StartupStateCopyWith<T, $Res> {
...
class Error<T> implements StartupState<T> {
...
@override
String toString() {
  return 'StartupState<$T>.error(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $StartupStateCopyWith<T, $Res> {
